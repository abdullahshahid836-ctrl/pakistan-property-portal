                ...
                >
                  ...
                  {i === 7 && (
                    <>
                      ...
                      {/* Refined Top-right inverted corner */}
                      <div className="absolute -top-[1px] -right-[1px] w-16 h-16 pointer-events-none z-10 overflow-hidden translate-x-full -translate-y-full">
