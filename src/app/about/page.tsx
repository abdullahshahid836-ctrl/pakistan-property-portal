  ...
  return (
    <>
      ...
      <div className="bg-[#F5F0E8] min-h-screen overflow-x-hidden">
        ...
        ═══════════════════════════════════════════════════ */}
        <section className="relative min-h-screen bg-[#F5F0E8] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
            <div className="flex flex-col items-center text-center">
              ...
              <FadeUp delay={0.1}>
                <span className="inline-block mb-10 px-6 py-2 bg-[#004737] text-[#C8F55A] font-syne font-black text-[10px] uppercase tracking-[0.4em] rounded-full">
                  ABOUT US
                </span>
              </FadeUp>
              ...
              <div className="mb-20">
                <Line delay={0.2} className="mb-2">
                  <h1 className="font-syne font-black text-[clamp(3.5rem,10vw,9rem)] text-[#0D1B17] uppercase tracking-tighter leading-[0.85]">
                    Pakistan&apos;s
                  </h1>
                </Line>
                <Line delay={0.3} className="mb-2">
                  <h1 className="font-syne font-black text-[clamp(3.5rem,10vw,9rem)] text-[#004737] italic uppercase tracking-tighter leading-[0.85]">
                    Most Trusted
                  </h1>
                </Line>
                <Line delay={0.4}>
