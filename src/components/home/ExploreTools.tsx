        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
          {tools.map((tool, idx) => (
            <Link 
              key={idx} 
              href={tool.href}
              className="group flex flex-col items-center text-center p-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-[0_1px_3px_rgba(0,0,0,0.06)] hover:shadow-[0_12px_30px_rgba(30,107,255,0.1)] hover:border-[#1E6BFF]/30 transition-all duration-300"
            >
